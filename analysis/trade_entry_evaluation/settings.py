...
_CONTINUATION_DEPLOYMENT_THRESHOLD = 0.75
_REVERSAL_DEPLOYMENT_THRESHOLD = 0.75
...
_DEPLOYMENT_EVIDENCE_LOOKBACK_DAYS = 1825
_TRAINING_HISTORY_PERIOD = "5y"
...
_DEPLOYMENT_WILSON_Z = 1.96
_DEPLOY_MIN_SIGNAL_BACKTEST_CALLS = 5
_DEPLOY_MIN_BACKTEST_ACCURACY = 0.75
_DEPLOY_MIN_BACKTEST_REVERSE_ACCURACY = 0.75
_DEPLOY_MIN_BACKTEST_CONTINUE_ACCURACY = 0.75
_DEPLOY_MIN_BACKTEST_WILSON = 0.40
_DEPLOY_MIN_BACKTEST_REVERSE_WILSON = 0.40
_DEPLOY_MIN_BACKTEST_CONTINUE_WILSON = 0.40
_DEPLOY_MIN_SIGNAL_BACKTEST_ACCURACY = 0.80
_DEPLOY_MIN_SIGNAL_BACKTEST_REVERSE_WILSON = 0.50
_DEPLOY_MIN_SIGNAL_BACKTEST_CONTINUE_WILSON = 0.50
_DEPLOY_MIN_FALLBACK_SIGNAL_BACKTEST_CALLS = 5
_DEPLOY_MIN_FALLBACK_SIGNAL_ACCURACY = 0.80
_DEPLOY_MIN_FALLBACK_SIGNAL_REVERSE_WILSON = 0.45
_DEPLOY_MIN_FALLBACK_SIGNAL_CONTINUE_WILSON = 0.45
_DEPLOY_MIN_BROAD_FAMILY_BACKTEST_CALLS = 6
_DEPLOY_MIN_BROAD_FAMILY_ACCURACY = 0.80
_DEPLOY_MIN_BROAD_FAMILY_WILSON = 0.45
_DEPLOY_MIN_SIGNAL_EXPECTED_RETURN = 0.0
...
_RAW_BACKTEST_REPORTING_POLICY = "raw_walk_forward_no_in_sample_gate_or_repair"
_BACKTEST_REPORTING_POLICY = "walk_forward_prior_evidence_deployment_gate"
...
_EMPIRICAL_REVERSAL_MIN_PRECISION = 0.85
_EMPIRICAL_CONTINUATION_MIN_PRECISION = 0.85
_EMPIRICAL_REVERSAL_MIN_WILSON = 0.45
_EMPIRICAL_CONTINUATION_MIN_WILSON = 0.45
_EMPIRICAL_REVERSAL_MIN_MATCHES = 10
_EMPIRICAL_CONTINUATION_MIN_MATCHES = 10
_EMPIRICAL_REVERSAL_MIN_RECENT_PRECISION = 0.60
_EMPIRICAL_CONTINUATION_MIN_RECENT_PRECISION = 0.60
...
_EMPIRICAL_RECENT_REVERSAL_MIN_FULL_PRECISION = 0.78
_EMPIRICAL_RECENT_CONTINUATION_MIN_FULL_PRECISION = 0.72
